  ...
  entries: [
    {
      ...
      entidad: 'DetalleValores', idEntidad: 1, descripcionEntidad: 'ET1-F1 Acondicionamiento — SYNAPTOMAX 250mg',
    ...
    },
    {
      ...
      entidad: 'FirmaCierre', idEntidad: 1, descripcionEntidad: 'Firma cierre ET1 — SYNAPTOMAX 250mg Lote LL-2024-001',
      accion: 'FIRMAR_CIERRE', modulo: 'Batch Record',
    },
    {
      id: 'a-003', timestamp: '2025-10-20T07:30:00Z',
      idUsuario: 3, nombreUsuario: 'Ana Torres', loginUsuario: 'operario', cargo: 'Técnico de Producción',
      entidad: 'DetalleValores', idEntidad: 2, descripcionEntidad: 'ET1-F1 Granulación — CARBOPLEX 500mg',
      accion: 'MODIFICAR', modulo: 'Batch Record',
      cambios: [
    ...
    },
    {
      ...
      idUsuario: 2, nombreUsuario: 'María López', loginUsuario: 'supervisor', cargo: 'Supervisora de Turno',
      entidad: 'FirmaCierre', idEntidad: 2, descripcionEntidad: 'Firma cierre ET1 — CARBOPLEX 500mg',
      accion: 'FIRMAR_CIERRE', modulo: 'Batch Record',
    },
    {
      id: 'a-005', timestamp: '2025-10-21T08:00:00Z',
      idUsuario: 3, nombreUsuario: 'Ana Torres', loginUsuario: 'operario', cargo: 'Técnico de Producción',
      entidad: 'DetalleValores', idEntidad: 2, descripcionEntidad: 'ET2-F1 Encapsulado — CARBOPLEX 500mg',
      accion: 'MODIFICAR', modulo: 'Batch Record',
    ...
    },
    {
      ...
      idUsuario: 3, nombreUsuario: 'Ana Torres', loginUsuario: 'operario', cargo: 'Técnico de Producción',
      entidad: 'Desviacion', idEntidad: 3, descripcionEntidad: 'Velocidad encapsuladora fuera de rango — BR-3 ET2-F1',
    ...
    },
    {
      ...
      idUsuario: 2, nombreUsuario: 'María López', loginUsuario: 'supervisor', cargo: 'Supervisora de Turno',
      entidad: 'Desviacion', idEntidad: 3, descripcionEntidad: 'Cierre desviación velocidad encapsuladora — BR-3',
    ...
    },
    {
      ...
      idUsuario: 3, nombreUsuario: 'Ana Torres', loginUsuario: 'operario', cargo: 'Técnico de Producción',
      entidad: 'Desviacion', idEntidad: 5, descripcionEntidad: 'Temperatura sala fuera de rango — BR-5 ET1-F1',
      accion: 'REGISTRAR_DESVIACION', modulo: 'Batch Record',
