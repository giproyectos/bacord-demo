...
export let mockGruposResponsables: GrupoResponsable[] = [
  { id: 1, nombre: 'Producción',      descripcion: 'Operarios de Producción',          colorKey: 'blue',   activo: true },
  { id: 2, nombre: 'Supervisión',     descripcion: 'Supervisores de Producción',        colorKey: 'green',  activo: true },
  { id: 3, nombre: 'Calidad',         descripcion: 'Control de Calidad',                colorKey: 'purple', activo: true },
  { id: 4, nombre: 'Dirección',       descripcion: 'Dirección Técnica de Planta',       colorKey: 'orange', activo: true },
  { id: 5, nombre: 'Administradores', descripcion: 'Administradores del Sistema',       colorKey: 'slate',  activo: true },
]
...
export const mockUsuarios: Usuario[] = [
  {
    ...
    idRol: 2, rolNombre: 'Producción',
    fechaCaducidad: null, activacionPendiente: false,
    pinConfigurado: true, pinBloqueado: false, loginLocalDeshabilitado: false,
...
export const mockDesviaciones: Desviacion[] = [
  ...
  // ── BR-4: SYNZ-2025-004 — desviaciones cerradas (lote liberado) ────────────
  {
    id: 3,
    idBatchRecord: 4,
    idDetalle: 102,
    detalleCode: 'ET1-F2',
    campo: 'numPctDesv_MCC',
    labelCampo: '% Desviación Pesaje — MCC PH-102',
    valorIngresado: '0.86%',
    limiteInfo: 'Alerta: >0.5% | Acción: >1.0%',
    descripcion: 'Desviación de pesaje en MCC PH-102 (MP-MCC-04): cantidad pesada 10.59 kg vs. teórico 10.50 kg (+0.09 kg, +0.86%). Supera límite de alerta del 0.5% pero dentro del límite de acción del 1.0%. Se notificó a CCA para evaluación de impacto.',
    estado: 'cerrada',
    usuario: 'Carlos Méndez',
    cargo: 'Técnico de Dispensación',
    fechaHora: '2025-03-10T08:58:00.000Z',
    observacionCierre: 'Evaluación de impacto completada por CCA. La variación de +0.86% en excipiente diluyente (MCC PH-102) no compromete la uniformidad de contenido ni la potencia del producto. Lote continúa proceso según protocolo. Referencia: DEV-2025-042.',
    fechaCierre: '2025-03-10T10:15:00.000Z',
    usuarioCierre: 'Diana Morales — Directora CCA',
  },
  {
    id: 4,
    idBatchRecord: 4,
    ...
    detalleCode: 'ET2-F1',
    campo: 'numVelocidadObj',
    labelCampo: 'Velocidad Encapsuladora (cáps/h)',
    valorIngresado: '91500',
    limiteInfo: 'Objetivo: 85000 | Límite superior: 90000',
    descripcion: 'Durante el pre-arranque de encapsulado, la velocidad inicial de la MG2 Planeta se registró en 91500 cáps/h, superando el límite superior de proceso de 90000 cáps/h. El operador ajustó la velocidad a 86200 cáps/h dentro del rango objetivo antes de iniciar la producción.',
    estado: 'cerrada',
    usuario: 'Laura Ríos',
    cargo: 'Operario de Encapsulado',
    fechaHora: '2025-03-10T10:32:00.000Z',
    observacionCierre: 'Velocidad corregida a 86200 cáps/h (dentro de rango 80000–90000). Se verificó que los primeros 500 capsulas producidas cumplieron especificación de peso (680 ± 10 mg). No hay impacto en calidad del lote. Equipo ajustado y operación reanudada.',
    fechaCierre: '2025-03-10T10:50:00.000Z',
    usuarioCierre: 'Laura Ríos — Operario de Encapsulado',
  },
]
