...
## BACord Project Context

This skill is pre-configured for the BACord pharmaceutical EBR demo:
- **Product type:** Healthcare SaaS / Enterprise dashboard
- **Stack:** React 18 + TypeScript + Vite 6, Tailwind CSS 4, Chart.js
- **Default --stack flag:** `react`
- **Default -p flag:** `BACord`
- **Established design tokens:** navy `#0A2D63`, primary `#1D4ED8`, teal `#0891B2`, success `#059669`

When generating design systems for BACord, use `--stack react` and respect the established token palette above unless the user explicitly wants alternatives.
